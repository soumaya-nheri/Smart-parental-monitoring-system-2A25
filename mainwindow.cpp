    ...
    , ui(new Ui::MainWindow)
{
    ...
    QFile file("C:/Users/msi/Desktop/Historique.txt");
...
void MainWindow::on_btn_ajout_clicked()
{
    ...
    int numero=ui->line_num->text().toInt();
        ...
        int etat=ui->comboBox_2->currentText().toInt();
